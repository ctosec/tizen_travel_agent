...
export default function DestinationPage() {
  ...
  return (
    <FocusContext.Provider value={focusKey}>
      <div
        ref={ref}
        className="w-[1920px] h-[1080px] bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex flex-col overflow-hidden"
      >
        {/* Header */}
        ...
        {/* Attraction Cards */}
        <div className="flex-1 flex items-center justify-center px-20 py-8">
          {loading ? (
        ...
        {/* Make a Trip Button */}
        <div className="flex justify-end px-20 mb-16">
          <FocusableButton
          ...
          >
            <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-16 py-7 rounded-full text-3xl shadow-2xl transition-all duration-300 flex items-center gap-4">
              Make a Trip
